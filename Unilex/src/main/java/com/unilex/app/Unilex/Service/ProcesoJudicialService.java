...
public class ProcesoJudicialService {
    ...
    public List<ProcesoJudicial> listarProcesos() {
        ...
        return List.of(
                new ProcesoJudicial(1L, "11001310300120230012300", "Juzgado 1 Civil del Circuito"),
                new ProcesoJudicial(2L, "11001400300220230045600", "Juzgado 2 Promiscuo Municipal")
        );
    }
}